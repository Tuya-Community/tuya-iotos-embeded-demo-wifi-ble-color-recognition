...
This Demo is based on Tuya Smart Cloud Platform, Tuya Smart APP, IoTOS Embeded WiFi &Ble SDK, using Tuya WiFi/WiFi+BLE series modules to quickly set up a color recognition demo with rgb color values for detecting recognized colors and displaying the detection and recognition results on the mobile app.
## Quick start
...
+ Call the application layer initialization function app_color_init()
